...
Item {
    ...
    ColumnLayout { anchors.fill:parent; spacing:Theme.spacing.md
        RowLayout { Layout.fillWidth:true
            ...
            Repeater { model:["overview","sources","claims","brief","script","visuals"]; AppButton { text:modelData.charAt(0).toUpperCase()+modelData.slice(1); compact:true; variant:root.currentTab===modelData?"secondary":"ghost"; onClicked:root.currentTab=modelData } }
        }
