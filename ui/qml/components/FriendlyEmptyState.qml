...
Item {
    ...
    ColumnLayout { anchors.centerIn: parent; width: Math.min(parent.width - 32, 360); spacing: Theme.spacing.sm
        ...
        Text { Layout.fillWidth: true; text: root.description; horizontalAlignment: Text.AlignHCenter; wrapMode: Text.WordWrap; color: Theme.colors.textSecondary; font.family: Theme.type.family; font.pixelSize: Theme.type.small; lineHeightMode: Text.ProportionalHeight; lineHeight: Theme.type.multilingualLineHeight }
