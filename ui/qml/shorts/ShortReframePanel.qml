...
AppCard {
    ColumnLayout {
        ...
        AppComboBox { id:scene; Layout.fillWidth:true; model:Shorts.sceneOptions; textRole:"name" }
        ...
        RowLayout { Layout.fillWidth:true
            ...
            Slider { id:zoom; Layout.fillWidth:true; from:1; to:2.5; value:1; stepSize:.05 }
        }
