...
Item {
    ...
    ColumnLayout { anchors.fill: parent; spacing: Theme.spacing.md
        ...
        TextField { Layout.fillWidth: true; placeholderText: "Batch name"; text: root.batchName; onTextChanged: root.batchName=text }
        ComboBox {
            id: templates
        ...
        TextField { Layout.fillWidth: true; placeholderText: "Output folder"; text: root.outputFolder; onTextChanged: root.outputFolder=text }
        ...
        Button { text: "Continue to Data"; enabled: root.templateId.length>0 && root.outputFolder.length>0; onClicked: root.nextRequested() }
