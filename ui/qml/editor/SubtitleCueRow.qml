...
AppCard {
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            SecondaryButton { text: "▶"; compact: true; onClicked: { root.selectRequested(root.cueId); if (root.controller) root.controller.playSelected(true) } }
        }
        ...
        TextArea {
            ...
            onActiveFocusChanged: if (!activeFocus && root.controller) root.controller.queueText(root.cueId, text, secondary.text)
        }
        ...
        TextArea {
            ...
            onActiveFocusChanged: if (!activeFocus && root.controller) root.controller.queueText(root.cueId, primary.text, text)
        }
