...
AppCard {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            ColumnLayout { Layout.fillWidth: true
                ...
                RowLayout { Layout.fillWidth: true
                    AppTextField { Layout.fillWidth: true; accessibleName: "Export width"; text: String(root.exportWidth); validator: IntValidator { bottom: 16; top: 7680 }; onEditingFinished: { root.exportWidth=Number(text); root.changed() } }
                    Text { text: "×"; color: Theme.colors.textMuted }
                    AppTextField { Layout.fillWidth: true; accessibleName: "Export height"; text: String(root.exportHeight); validator: IntValidator { bottom: 16; top: 7680 }; onEditingFinished: { root.exportHeight=Number(text); root.changed() } }
                }
            }
            ColumnLayout { Layout.fillWidth: true
                Text { text: "FPS"; color: Theme.colors.textSecondary; font.family: Theme.type.family; font.pixelSize: Theme.type.caption }
                AppComboBox { Layout.fillWidth: true; accessibleName: "Export FPS"; model: [24,25,30,50,60]; Component.onCompleted: currentIndex=Math.max(0,model.indexOf(root.exportFps)); onActivated: { root.exportFps=Number(currentText); root.changed() } }
            }
            ColumnLayout { Layout.fillWidth: true
                Text { text: "Quality"; color: Theme.colors.textSecondary; font.family: Theme.type.family; font.pixelSize: Theme.type.caption }
                AppComboBox { Layout.fillWidth: true; accessibleName: "Export quality"; model: [{"id":"fast","name":"Fast"},{"id":"balanced","name":"Balanced"},{"id":"high","name":"High Quality"}]; textRole:"name"; valueRole:"id"; currentIndex: root.quality==="fast"?0:(root.quality==="high"?2:1); onActivated: { root.quality=currentValue; root.changed() } }
            }
            ColumnLayout { Layout.fillWidth: true
                Text { text: "Encoder"; color: Theme.colors.textSecondary; font.family: Theme.type.family; font.pixelSize: Theme.type.caption }
                AppComboBox { Layout.fillWidth: true; accessibleName: "Encoder"; model: root.encoderRows(); textRole:"name"; valueRole:"id"; onActivated: { root.encoder=currentValue || "auto"; root.changed() } }
            }
            ColumnLayout { Layout.fillWidth: true
            ...
            ColumnLayout { Layout.fillWidth: true; visible: root.subtitleMode !== "none"
                ...
                AppComboBox { Layout.fillWidth: true; accessibleName: "Subtitle track"; model: root.subtitleRows(); textRole:"name"; valueRole:"id"; onActivated: { root.subtitleTrackId=currentValue || ""; root.changed() } }
            }
            ColumnLayout { Layout.fillWidth: true
                ...
                AppComboBox { Layout.fillWidth: true; accessibleName: "Aspect conversion"; model: [{"id":"fit","name":"Fit"},{"id":"fill","name":"Fill"},{"id":"stretch","name":"Stretch"}]; textRole:"name"; valueRole:"id"; currentIndex: root.fitMode==="fit"?0:(root.fitMode==="stretch"?2:1); onActivated: { root.fitMode=currentValue; root.changed() } }
            }
            ColumnLayout { Layout.fillWidth: true
                ...
                AppComboBox { Layout.fillWidth: true; accessibleName: "If file exists"; model: [{"id":"keep_both","name":"Keep Both"},{"id":"replace","name":"Replace"},{"id":"cancel","name":"Cancel"}]; textRole:"name"; valueRole:"id"; currentIndex: root.overwritePolicy==="replace"?1:(root.overwritePolicy==="cancel"?2:0); onActivated: { root.overwritePolicy=currentValue; root.changed() } }
            }
        }
        ColumnLayout { Layout.fillWidth: true; spacing: Theme.spacing.xs
            ...
            RowLayout { Layout.fillWidth: true
                AppTextField { Layout.fillWidth: true; accessibleName: "Output folder"; text: root.outputFolder; onEditingFinished: { root.outputFolder=text; root.changed() } }
        ...
        ColumnLayout { Layout.fillWidth: true; spacing: Theme.spacing.xs
            ...
            AppTextField { Layout.fillWidth: true; accessibleName: "Export filename"; text: root.filename; onEditingFinished: { root.filename=text; root.changed() } }
        }
        RowLayout { Layout.fillWidth: true
            AppSwitch { accessibleName: "Include audio"; checked: root.audioEnabled; onToggled: { root.audioEnabled=checked; root.changed() } }
            ...
            AppSwitch { accessibleName: "Remember export settings for this project"; checked: root.rememberProject; onToggled: { root.rememberProject=checked; root.changed() } }
