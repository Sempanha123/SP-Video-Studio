...
Item {
    ...
    Component.onCompleted: { Commands.setContext("asset_library"); AssetLibrary.setCurrentProject(typeof projectController!=="undefined" ? (projectController.currentProject.id||"") : "") }
