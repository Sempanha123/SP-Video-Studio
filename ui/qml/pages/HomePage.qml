                ...
                AppCard {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout { Layout.fillWidth: true; Text { text: "AI models"; color: Theme.colors.textSecondary; font.family: Theme.type.family; font.pixelSize: Theme.type.bodySmall; Layout.fillWidth: true }; StatusBadge {
                            text: (root.readiness().voxcpmStatus === "repair-required" || root.readiness().whisperStatus === "repair-required") ? "Needs Repair" : ((root.readiness().voxcpmStatus === "installed" && root.readiness().whisperStatus === "installed") ? "Installed" : ((root.readiness().voxcpmStatus === "installed" || root.readiness().whisperStatus === "installed") ? "Partial" : "Not Installed"))
                            status: (root.readiness().voxcpmStatus === "repair-required" || root.readiness().whisperStatus === "repair-required") ? "repair-required" : ((root.readiness().voxcpmStatus === "installed" && root.readiness().whisperStatus === "installed") ? "installed" : "not-installed")
                        } }
                        Item { Layout.fillHeight: true }
                        RowLayout {
                            Layout.fillWidth: true
